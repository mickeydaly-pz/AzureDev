...
.\Install-AD.ps1 -dsrmPassword (ConvertTo-SecureString $dsrmPassword -AsPlainText -Force) -localPassword (ConvertTo-SecureString $localPassword -AsPlainText -Force) -domainName $domainName -backupDC $backupDC -username "maadmin"